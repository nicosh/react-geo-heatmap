          ...
          <section>
            <div className="container-fluid">
                <div className="row">
                  ...
                  <a target="_blank" class="Header-link" href="https://github.com/nicosh/react-geo-heatmap" data-hotkey="g d" aria-label="Homepage" data-ga-click="Header, go to dashboard, icon:logo">
